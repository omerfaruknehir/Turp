...
class LegalWebsiteIntegrationTest {
    ...
    fun `website icon uses the exact Android launcher variants`() {
        ...
        assertTrue(site.contains("backgroundStart: '#712828'"))
        assertTrue(site.contains("backgroundEnd: '#b93838'"))
        assertTrue(site.contains("leafStart: '#d0a390'"))
        assertTrue(site.contains("leafMid: '#e1c5b8'"))
        assertTrue(site.contains("leafEnd: '#f0ddd5'"))
        assertTrue(site.contains("bulbStart: '#f3e4de'"))
        assertTrue(site.contains("bulbMid: '#e6cbc0'"))
        assertTrue(site.contains("bulbEnd: '#cc927a'"))
        assertTrue(site.contains("backgroundStart: '#293b52'"))
        assertTrue(site.contains("leafStart: '#a9d4ff'"))
        assertTrue(site.contains("bulbMid: '#ffb4a9'"))
        ...
        assertTrue(site.contains("M45.355735,12.06325"))
        assertTrue(site.contains("M54,24.484818"))
        assertTrue(site.contains("<linearGradient id=\"leaf\""))
        assertTrue(site.contains("<radialGradient id=\"bulb\""))
        assertTrue(site.contains("<feGaussianBlur stdDeviation=\"3.2\"/>"))

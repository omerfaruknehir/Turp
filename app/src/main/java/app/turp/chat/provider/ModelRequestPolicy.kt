...
object ModelRequestPolicy {
     ...
     * Turp's client-side web-search path instead of sending an invalid /responses request.
     */
     ...
     * model families whose request protocol is stable enough for Turp to use.
     */
    ...
    /** Repair model rows cached by older Turp builds without waiting for a manual catalog refresh. */

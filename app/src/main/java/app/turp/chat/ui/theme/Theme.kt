...
private val TurpLight = lightColorScheme(
    ...
    surface = Color(0xFFFAF9FA), onSurface = Color(0xFF1C1B1D),
    surfaceVariant = Color(0xFFE7E2E4), onSurfaceVariant = Color(0xFF4B4648),
    outline = Color(0xFF7C7477), outlineVariant = Color(0xFFCEC7CA),
    surfaceContainerLowest = Color.White, surfaceContainerLow = Color(0xFFF5F3F4),
    surfaceContainer = Color(0xFFEFECED), surfaceContainerHigh = Color(0xFFE9E6E7),
    surfaceContainerHighest = Color(0xFFE3E0E1),
    inverseSurface = Color(0xFF313033), inverseOnSurface = Color(0xFFF4EFF1), inversePrimary = Color(0xFFFFB0C5),
...
private val TurpDark = darkColorScheme(
    ...
    surface = Color(0xFF111113), onSurface = Color(0xFFE7E1E3),
    surfaceVariant = Color(0xFF494649), onSurfaceVariant = Color(0xFFCEC5C8),
    outline = Color(0xFF988F92), outlineVariant = Color(0xFF494649),
    surfaceContainerLowest = Color(0xFF0C0C0E), surfaceContainerLow = Color(0xFF18181B),
    surfaceContainer = Color(0xFF1E1E21), surfaceContainerHigh = Color(0xFF252529),
    surfaceContainerHighest = Color(0xFF2C2C31),
    inverseSurface = Color(0xFFE7E1E3), inverseOnSurface = Color(0xFF313033), inversePrimary = Color(0xFF9F244A),

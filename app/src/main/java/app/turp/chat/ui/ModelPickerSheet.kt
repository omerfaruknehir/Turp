...
import app.turp.chat.provider.imageModelCapabilities
import app.turp.chat.settings.modelPreferenceKey
        ...
        Column(
            ...
            verticalArrangement = Arrangement.spacedBy(10.dp),
                ...
                Row(Modifier.fillMaxWidth(), verticalAlignment = Alignment.CenterVertically) {
                    ...
                    IconButton(onClick = ::dismissSheet) { Icon(Icons.Outlined.Close, localizedTurpUiText("Close model picker")) }
                }
                            ...
                            trailingContent = {
                                IconButton(onClick = { onToggleFavorite(choice.provider.id, choice.model.modelId) }) {
                                    Icon(
                                        ...
                                        localizedTurpUiText(if (key in favoriteKeys) "Remove favorite" else "Add favorite"),

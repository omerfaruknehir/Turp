(() => {
  ...
  const paletteAccents = {
    turp: {
      dark: {
        '--primary': '#ffb0c5', '--on-primary': '#5c0a29',
        '--primary-container': '#4a2130', '--on-primary-container': '#ffd9e3',
        '--secondary': '#c3c8c3', '--on-secondary': '#2c312e',
        '--secondary-container': '#343936', '--on-secondary-container': '#dee3de',
        '--tertiary': '#c6c5d3', '--on-tertiary': '#2f303b',
        '--tertiary-container': '#3b3b48', '--on-tertiary-container': '#e2e2ee',
        '--background': '#111113', '--surface': '#111113',
        '--surface-low': '#18181b', '--surface-container': '#1e1e21',
        '--on-surface': '#e7e1e3', '--on-surface-variant': '#cec5c8',
        '--outline': '#988f92', '--outline-variant': '#494649',
        '--rail': '#0c0c0e',
      },
      light: {
        '--primary': '#9f244a', '--on-primary': '#ffffff',
        '--primary-container': '#f7dce4', '--on-primary-container': '#3c0a1c',
        '--secondary': '#5d625f', '--on-secondary': '#ffffff',
        '--secondary-container': '#e2e6e2', '--on-secondary-container': '#1b201d',
        '--tertiary': '#5d6070', '--on-tertiary': '#ffffff',
        '--tertiary-container': '#e2e2ee', '--on-tertiary-container': '#1a1b24',
        '--background': '#faf9fa', '--surface': '#faf9fa',
        '--surface-low': '#f5f3f4', '--surface-container': '#efeced',
        '--on-surface': '#1c1b1d', '--on-surface-variant': '#4b4648',
        '--outline': '#7c7477', '--outline-variant': '#cec7ca',
        '--rail': '#ffffff',
      },
    },
    arbor: { dark: {}, light: {} },

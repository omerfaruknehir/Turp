(() => {
  ...
  const palettes = {
    turp: { backgroundStart: '#712828', backgroundEnd: '#b93838', leafStart: '#d0a390', leafMid: '#e1c5b8', leafEnd: '#f0ddd5', bulbStart: '#f3e4de', bulbMid: '#e6cbc0', bulbEnd: '#cc927a', detail: '#d15140' },
    arbor: { backgroundStart: '#e7f4ea', backgroundEnd: '#b5f1cc', leafStart: '#286448', leafMid: '#3d6472', leafEnd: '#0d5033', bulbStart: '#f4fbff', bulbMid: '#c1eafb', bulbEnd: '#3d6472', detail: '#286448' },
    system: { backgroundStart: '#293b52', backgroundEnd: '#67507e', leafStart: '#a9d4ff', leafMid: '#c7dfff', leafEnd: '#e8ddff', bulbStart: '#ffe9e4', bulbMid: '#ffb4a9', bulbEnd: '#d47770', detail: '#67507e' },
    graphite: { backgroundStart: '#162234', backgroundEnd: '#425f86', leafStart: '#a9c7f8', leafMid: '#c8dafa', leafEnd: '#e7f0ff', bulbStart: '#fff4ed', bulbMid: '#e5bfa6', bulbEnd: '#b88769', detail: '#425f86' },
    ocean: { backgroundStart: '#00363f', backgroundEnd: '#00677a', leafStart: '#54d6f2', leafMid: '#9be8f8', leafEnd: '#d5f7ff', bulbStart: '#f3f5ff', bulbMid: '#bec6ea', bulbEnd: '#8e99cd', detail: '#00677a' },
    violet: { backgroundStart: '#2e1d4f', backgroundEnd: '#67508f', leafStart: '#d1bcff', leafMid: '#e1d4ff', leafEnd: '#f0e8ff', bulbStart: '#ffedf3', bulbMid: '#efb8c8', bulbEnd: '#c9829e', detail: '#67508f' },
    sunset: { backgroundStart: '#5c1a07', backgroundEnd: '#9b4425', leafStart: '#ffb59c', leafMid: '#ffd0bf', leafEnd: '#ffede7', bulbStart: '#fff6dd', bulbMid: '#d7c58d', bulbEnd: '#ac995e', detail: '#9b4425' },
  };
